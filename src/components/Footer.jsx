...
<Box  sx={{  display: 'flex', flexDirection: 'column',gap: 1 , justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Typography variant="body1" sx={{color: 'white'}}>
          ...
          <Stack direction="row" spacing={2} alignItems="center" justifyContent="center">
            <a href="https://www.linkedin.com/in/ahmed-selim-a80823289/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'white', display: 'flex', alignItems: 'center', gap: 1 }}>
              <LinkedInIcon /> LinkedIn
            </a>
            <a href="https://github.com/ahmed-mohamed33" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'white', display: 'flex', alignItems: 'center', gap: 1 }}>
              <GitHubIcon /> GitHub
            </a>
            <a href="mailto:a7medselim93@gmail.com" style={{ textDecoration: 'none', color: 'white', display: 'flex', alignItems: 'center', gap: 1 }}>
              <EmailIcon /> Email
            </a>
          </Stack>
